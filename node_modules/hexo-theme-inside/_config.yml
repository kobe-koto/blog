...
profile:
  ...
  avatar: https://avatars.githubusercontent.com/u/91669733

  bio: 這裏是沒錢也沒梗的kobe-koto.
...
sns:
  ...
  - icon: email
    title: Email
    url: mailto:admin@koto.cc
    
  - icon: github
    title: GitHub
    url: https://github.com/kobe-koto
    
  - icon: twitter
    title: Twitter
    url: https://twitter.com/evestar3905
    
  - icon: telegram
    title: Telegram
    url: https://t.me/kobe_koto
    
  - icon: facebook
    title: Facebook
    url: https://www.facebook.com/profile.php?id=100075633594530
...
# Plugins
plugins:
  - //3905.cf/npm/gitalk@1/dist/gitalk.css
  - //3905.cf/npm/gitalk@1/dist/gitalk.min.js
  - position: comments
    template: | 
      <div id="gitalk-container"></div><script>const gitalk = new Gitalk({clientID: 'af35a4f3f124cd8b4be2',clientSecret: 'a924b995fb39ee25b426bb1b9cf5c13a02d32f9d',repo: 'sunyun.tk',owner: 'kobe-koto',admin: ['kobe-koto'],id: 'main',distractionFreeMode: false,proxy: 'https://cros-cf.ooze.gq/?https://github.com/login/oauth/access_token'});gitalk.render('gitalk-container')</script>
